...
export function ProductDetailsScreen({
  ...
  const calorieSources = getProductCalorieSources(product);
  const canCalculateCalories = calorieSources.length > 0;
  ...
  return (
    <Screen>
      ...
      <View style={[styles.summary, { borderTopColor: colors.border }]}>
        ...
        perServing?.energyKcal !== undefined ? (
          <ListRow
            colors={colors}
        ...
        {per100?.energyKcal !== null && per100?.energyKcal !== undefined ? (
          <ListRow
            colors={colors}
